$(document).ready(function () {
    ...
    add.click(function () {
        $(this).replaceWith("<div class='container-service'><span class='added text-danger'>لقد قمت بإضافة سائق إضافي</span> <button onClick='remove()' class='btn remove remove_service'><i class='fas fa-trash pr-2'></i>حذف</button></div>");
    });
    ...
    $('#send').click(function () {
        $.alert({
            ...
            title: 'شكرا لك',
            typeAnimated: true,
            content: 'تم ارسال الطلب وسيتم التواصل معك في اقرب وقت',
            buttons: false,
